...
void UI::Init()
{
	...
	TopLevelSession::GetInstance().InitiateMessage("Hello World! :D");
	TopLevelSession::GetInstance().InitiateMessage("The weather is hot today! :p");
	...
	TopLevelSession::GetInstance().InitiateMessage("My new car is great! ;)");
