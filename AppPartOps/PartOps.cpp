...
void Application::PartFile::ClosePart()
{
	...
	TopLevelSession::GetInstance().InitiateMessage(PartObserver::ClosePart, (void*)ptr);
}
...
void Application::PartFile::SavePart()
{
	...
	TopLevelSession::GetInstance().InitiateMessage(PartObserver::SavePart, (void*)ptr);
}
...
Application::PartFile* Application::PartFile::CreatePartFile(std::string partFilePath)
{
	...
	TopLevelSession::GetInstance().InitiateMessage(PartObserver::CreatePart, (void*)ptr);
	return partFile;
}
...
Application::PartFile* Application::PartFile::OpenPartFile(std::string partFilePath)
{
	...
	TopLevelSession::GetInstance().InitiateMessage(PartObserver::OpenPart, (void*)ptr);
